...
SYSTEM_PROMPT = (
    ...
    "chat history, so it can be answered without seeing that history. Resolve pronouns "
    "and shorthand (we, that, there, then) into explicit people, places, and dates from "
    "the history. Example: history mentions hanging out with Alex on December 13th 2025, "
    "new question 'What did we eat?' -> 'What did I eat with Alex on December 13th, 2025?'. "
